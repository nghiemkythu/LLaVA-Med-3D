...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        if getattr(self, 'mm_projector', None) is None:
            print("=================projector does not exist============")
            ...
            print("=================projector exist============")
            for n, param in self.mm_projector.named_parameters():
                print(n, param.shape)
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        #print(self.get_model().get_vision_tower()(images))
        with torch.no_grad():
            image_features, image_forward_outs = self.get_model().get_vision_tower().forward(images)
