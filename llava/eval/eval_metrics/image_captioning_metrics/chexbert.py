...
if __name__ == '__main__':
    ...
    t = time.time()
    accuracy, accuracy_not_averaged, class_report, class_report_5, _ = m("/netscratch/duynguyen/Research/Nghiem_LLaVA-Med/Data_Report_Gen/iu_xray/test.json",
                                                                         "/netscratch/duynguyen/Research/trung_LLaVA-Med/LVLM-Med/results/100_1e0_multi_graph_100_scale_test_bugfix_2e-5_gpt.jsonl")
        # m(hyps=['No pleural effusion. Normal heart size.',
    #           'Normal heart size.'
    #           ],
